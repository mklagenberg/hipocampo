...
- merge PR #27 (complete translation of the `hipocampo` repository into English, with a redirect stub at every renamed path, plus the repository/vault language policy, `decisions/0034`) and its follow-up PR (controlled-vocabulary dictionary, `decisions/0035`);
