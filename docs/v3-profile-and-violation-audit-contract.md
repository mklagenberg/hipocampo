...
violations or attempted violations concerning that vault. Authorized users may
read and write within the vault boundary. Corrections are additive and retain
the original event.
