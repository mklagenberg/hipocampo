...
The structural audit treats privacy, security, and provenance as a core criterion, but its scope is the explicitly selected documents and maintenance queue. Findings do not repeat secrets or restricted values and are never remediated automatically.
