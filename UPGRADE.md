...
- [ ] **[Obrigatório, desde a v1.9 não lançado]** Este repositório **não tem** uma pasta `skill/` própria. A skill roda sempre client-side, por pessoa/ambiente de IA — nunca por repositório (ver `decisions/0025-skill-client-side-nunca-por-repositorio.md`). Se sua instância ainda carrega uma pasta `skill/` (herdada do "Use this template"), apague-a — ela nunca teve efeito funcional, e mantê-la sugere um modelo mental errado ("cada repo tem sua própria skill").
